         ...
         <div className="col-md-8 col-md-offset-2">
           <div className="panel panel-primary">
              <div className="panel-heading">
                <div className="panel-title">Height Weight Ratio</div>
              </div>
              <div className="panel-body">
                ...
                <div className="form-group">
                  ...
                  <input type="text" id="height" className="form-control" placeholder="Enter Height" required/>
                </div>
                <div className="form-group">
                  <label htmlFor="weight">Weight:</label>
                  <input type="text" id="weight" className="form-control" placeholder="Enter Weight" required/>
                </div>
